...
export function XShareIcon({ className }: ShareIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden
...
export function WhatsAppShareIcon({ className }: ShareIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden
...
export function FacebookShareIcon({ className }: ShareIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden
...
export function LinkedInShareIcon({ className }: ShareIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden
...
export type ShareIcon = ComponentType<ShareIconProps>;
