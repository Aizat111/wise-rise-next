...
import { COMING_SOON_CONTAINER_CLASS } from "@/features/coming-soon/constants";
...
export default function YakindaGeleceklerError({ reset }: Props) {
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      />
      <div className={COMING_SOON_CONTAINER_CLASS}>
        <div
          role="alert"
