...
import { UserAgreementPage } from "@/features/information/pages/UserAgreementPage";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildInformationMetadata({
    locale,
    path: INFORMATION_ROUTES.termsOfService,
    title: t("pages.userAgreement"),
  });
}

/** Footer "Şartlar ve Koşullar" — aynı kullanıcı sözleşmesi içeriği. */
export default async function SartlarVeKosullarRoute({ params }: Props) {
  const { locale } = await params;
