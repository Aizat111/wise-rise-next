...
import { CookiePolicyPage } from "@/features/information/pages/CookiePolicyPage";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildInformationMetadata({
    locale,
    path: INFORMATION_ROUTES.cookiePolicy,
    title: t("pages.cookiePolicy"),
  });
}

export default async function CerezPolitikasiRoute({ params }: Props) {
  const { locale } = await params;
